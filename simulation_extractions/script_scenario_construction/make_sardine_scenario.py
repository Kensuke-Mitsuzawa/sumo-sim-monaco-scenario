...
scenario_name: str = config_obj['SCENARIO_NAME_SARDINE']
...
shutil.copy('./rerouter_sardine_scenario.xml', path_dir_scenario / scenario_name / 'rerouter.xml')
